...
#define LOG_TAG "tegra3 PowerHAL"
#include <utils/Log.h>
...
static void main_power_init( __attribute__((unused)) struct power_module *module)
{
    /*
...
static void main_power_set_interactive(__attribute__((unused)) struct power_module *module,
...
static void main_power_hint(__attribute__((unused)) struct power_module *module, power_hint_t hint,
                            void *data)
{
    char buf[80];
    int len, cpu, ret;
